...
![alpine](https://img.shields.io/badge/alpine-edge-0D597F?style=for-the-badge&logo=alpine-linux) ![mariadb](https://img.shields.io/badge/mariadb-${APP_VERSION}-003545?style=for-the-badge&logo=mariadb)
...
To upgrade, all you have to do is pull the latest Docker image. We automatically check for MariaDB updates daily so there may be some delay when an update is released to when the image is updated." >README.md
